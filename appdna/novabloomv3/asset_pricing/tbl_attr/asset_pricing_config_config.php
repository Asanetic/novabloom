...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  $__page_title ="Asset pricing";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"asset_pricing",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"asset_pricing",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    "db_schema" => [
        ...
        "custom_tbl_cols" => [
           "asset_pricing" => ["total_subscriptions"]
        ],
...
// columns : "primkey" , "record_id" , "asset_id" , "pricing_type" , "price_model" , "amount" , "unit_price" , "currency" , "billing_cycle" , "effective_from" , "effective_to" , "status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , "model_name" , "model_features" , 
    ...
    "page_layout" => [
        ...
        "form_input_segmentation_arr" => [
            "asset_pricing" => [
                "Model Details" => ["asset_id","model_name","pricing_type","price_model"],
        ...
        "static_drop_down_array" => [
            ...
            "price_model" => "flat_rate,per_unit,tiered,volume,stairstep",
        ...
        "rename_cols_array" => [ 
            "asset_id" => "Asset Name:col-md-6",
            "model_name"=>"Model name:col-md-6",
            "pricing_type" => "Pricing Type:col-md-6",
            "price_model" => "Price Model:col-md-6",
            "amount" => "Amount",
            "unit_price" => "Unit Price",
            "currency" => "Currency",
            "billing_cycle" => "Billing period:col-md-3",
  ...
  $global_new_drop_down_link_arr = [
        ...
        /* "users: View Subscriptions" => [
             "fe" => "viewPricingSubscriptions(listasset_pricing_result.record_id)",
             "file" => "pricing-details"
         ],
         "shopping-cart: View Orders" => [
             "fe" => "viewPricingOrders(listasset_pricing_result.record_id)",
             "file" => "pricing-details"
         ]*/
      ]
  ];
  ...
  $interlink_lists=[
   "relatedPricing"=>[ 
     "filter_str"=>" {assetId:btoa(asset_pricingNode?.asset_id)}",
     "module_name"=>"Assetpricing",
     "list_title"=>"Related asset Pricing",
     "event_name"=>"InteprateAssetpricingEvent",
     "custom"=>false,
     "external"=>false,
     "alias"=>'asset_pricing', 
     "event_name"=>"InteprateAssetpricingEvent",
