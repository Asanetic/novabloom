...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  $modules_and_links_=[
    "profile_module_name"=>"apiprofile",
    "profile_module_link"=>"./apiprofile",
    "addnew_page_link"=>"./apiprofile",
    "list_module_name"=>"apilist",
    "list_page_link"=>"./apilist",
    "write_profile"=>true,
    "write_list"=>false
  ];
...
$csgrid_dictionary = [
  "data9" => "total_payments",          // image src
  "data1" => "profile_photo",       // alt text
  "data2" => "profile_photo",       // alt text
  "data3" => "full_name",      // display name
  "data4" => "total_subscriptions",          // subtitle
...
// columns : "primkey" , "record_id" , "account_id" , "payment_context" , "context_id" , "amount" , "currency" , "payment_method" , "payment_status" , "external_reference" , "paid_at" , "created_at" , "hive_site_id" , "hive_site_name" , "app_id" , "invoice_id" , 
        ...
        "custom_next_js_query_line_cols" => [
            "total_subscriptions" => [
                "function" => "await mosyCountRows('subscriptions', `where account_id ='\${row?.record_id}'`)",
                "args" => [],
                "return" => "data_res"
            ],
            "total_orders" => [
                "function" => "await mosyCountRows('orders', `where account_id ='\${row?.record_id}'`)",
                "args" => [],
                "return" => "data_res"
            ],
            "total_payments" => [
                "function" => "await mosySumRows('payments', 'amount', `where account_id ='\${row?.record_id}'`)",
                "args" => [],
                "return" => "data_res"
            ]
        ]
