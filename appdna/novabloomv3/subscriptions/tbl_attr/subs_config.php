...
// columns : "primkey" , "record_id" , "account_id" , "asset_id" , "pricing_id" , "start_date" , "next_billing_date" , "end_date" , "status" , "billing_cycle" , "amount" , "currency" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , 
        ...
        "new_label_buttons_arr" => [ 
            "subscriptions" => "plus-circle:New Subscription:{`Subscription -\${subscriptionsNode?.record_id} / \${subscriptionsNode?._app_users_full_name_account_id} / \${subscriptionsNode?._assets_asset_name_asset_id} - \${subscriptionsNode?._asset_pricing_model_name_pricing_id}   `}" // node formart tablenameNode eg acc_renewalsNode
        ],
...
// columns : "primkey" , "record_id" , "asset_id" , "pricing_type" , "price_model" , "amount" , "unit_price" , "currency" , "billing_cycle" , "effective_from" , "effective_to" , "status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , "model_name" , "model_features" , 
  ...
  $list_btn_table_array=[
      $primary_table__=>[
         "calendar: Filter by expiry Date" => [
             "fe" => "filterByBillingDate('../subscriptions/list','Expiry date','subscriptions','nextBillingDate')",
             "file" => "subscription-filters"
         ],
         "filter: Filter by status" => [
             "fe" => "filterByStats({router:router, stateSetters:stateItemSetters})",
             "file" => "subscription-filters"
         ],        
  ...
  $profile_btn_table_array=[
      $primary_table__=>[
         ...
         "mobile: Request payment" => [
             "fe" => "promptMobileStk(subscriptionsNode)",
             "be" => "promptMobileStk()",
             "file" => "prompt-payment"
         ],        
         ...
         "copy: Invoice history" => [
             "fe" => "viewSubscriptionInvoices(subscriptionsNode.record_id)",
             "file" => "subscription-details"
         ], 
      ],
  ];
  ...
  $global_new_drop_down_link_arr = [
        $primary_table__=>[
         "credit-card: View Payments" => [
             "fe" => "viewSubscriptionPayments(listsubscriptions_result.record_id)",
             "file" => "subscription-details"
         ],
          
         "send: Send Message" => [
             "fe" => "notifyUser(listsubscriptions_result.account_id, listsubscriptions_result._app_users_full_name_account_id)",
             "file" => "notify-user"
         ],
         "file-text: Generate invoice" => [
         ...
         "refresh: Renew Subscription" => [
             "fe" => "renewSubscription(listsubscriptions_result.record_id)",
             "be" => "renewSubscription()",
             "file" => "subscription-renewal"
         ],
         "copy: View invoices" => [
             "fe" => "viewSubscriptionInvoices(listsubscriptions_result.record_id)",
             "file" => "subscription-details"
         ],          
  ...
  $interlink_lists=[
   "subscriptionPayments"=>[ 
     "filter_str"=>"{contextId:btoa(subscriptionsNode?.record_id)}",
   ...
   "usageEvents"=>[ 
     "filter_str"=>"{NodeId:btoa(subscriptionsNode?.account_id)}",
