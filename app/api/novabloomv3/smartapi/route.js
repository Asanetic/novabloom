...
import { generateSubInvoice } from "../subscriptions/logicControl/generate-sub-invoice";
...
import { sendPaymentReceipt } from "../payments/logicControl/payment-notifications";
import { addInvoicePayments } from "../invoices/logicControl/invoice-payments";
import { receiveMpesaPayment } from "../payments/logicControl/receive-mpesa-payment";

// One map. One truth.
const ACTIONS = {
  senduserMessage: senduserMessage,
  renewSubscription: renewSubscription,
  generateSubInvoice: generateSubInvoice,
  promptMobileStk: promptMobileStk,
  ipromptMobileStk: promptMobileStk,
  addInvoicePayments: addInvoicePayments,
  sendPaymentReceipt: sendPaymentReceipt,
  receivePayment: receiveMpesaPayment
};
