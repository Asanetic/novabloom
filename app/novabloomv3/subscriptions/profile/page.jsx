...
import SubscriptionsProfile from '../uiControl/SubscriptionsProfile';
...
export default function SubscriptionsMainProfilePage() {
             ...
             <div className="content container-fluid p-0 m-0 ">
               <Suspense fallback={<div className="col-md-12 p-5 text-center h3">Loading...</div>}>
                 <SubscriptionsProfile 
                    dataIn={{ parentUseEffectKey: "initSubscriptionsProfile" }} 
