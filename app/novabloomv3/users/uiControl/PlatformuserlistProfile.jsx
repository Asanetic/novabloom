...
import { intepratePlatformuserlistFormAction, platformuserlistProfileData , popDeleteDialog, IntepratePlatformuserlistEvent } from '../dataControl/PlatformuserlistRequestHandler';
...
export default function PlatformuserlistProfile({ dataIn = {}, dataOut = {} }) {
  ...
  const {
    ...
    customProfileData={},
    hostParent="PlatformuserlistMainProfilePage",
    parentProfileItemId = "PlatformuserlistProfileTray"
  ...
  const app_usersNode = stateItem.platformuserlistNode
  
  // -- basic states --//
  const paramPlatformuserlistUptoken  = stateItem.platformuserlistUptoken
  const platformuserlistActionStatus = stateItem.platformuserlistActionStatus
  ...
  const handleInputChange = mosyFormInputHandler(stateItemSetters.setPlatformuserlistNode);
  
  //use route navigation system
  const router = useRouter();
  
  //manage post form
  function postPlatformuserlistFormData(e) {
    
    MosyNotify({message: "Sending request",icon:"send"})
    
    intepratePlatformuserlistFormAction(e, stateItemSetters).then(response=>{
      
      setChildDataOut({
        
        actionName : response.actionName,
        dataToken : response.newToken,
        actionsSource : "postPlatformuserlistFormData",
        setters :{
      ...
      stateItemSetters.setActiveScrollId("PlatformuserlistProfileTray")
  ...
  useEffect(() => {
    ...
    platformuserlistProfileData(customQueryStr, stateItemSetters, router, customProfileData)
  ...
  return (
    ...
    <div className="p-0 col-md-12 text-center row justify-content-center m-0  " id="PlatformuserlistProfileTray">
      {/* ================== Start Feature Section========================== ------*/}
      
      
      <div className="col-md-12 rounded text-left p-2 mb-0  bg-white ">
        <div className={` profile_container col-md-12 m-0 p-0  ${showNavigationIsle &&("pr-lg-4 pl-lg-4 m-0")}`}>
          <form onSubmit={postPlatformuserlistFormData} encType="multipart/form-data" id="app_users_profile_form">
            ...
            <h3 className="col-md-12 title_text text-left p-0 pt-3 hive_profile_title row justify-content-center m-0 ">
              ...
              <>{!showNavigationIsle && (<div className="col m-0 p-0 text-right ">
                {paramPlatformuserlistUptoken && (
                  <DeleteButton
                  src="PlatformuserlistMainProfilePage"
                  tableName="app_users"
                  uptoken={paramPlatformuserlistUptoken}
            ...
            {paramPlatformuserlistUptoken && showNavigationIsle && (
              <>
          ...
          <div className="col-md-12 row p-0 justify-content-center p-0 m-0">
            ...
            <div className="col-md-11 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
              ...
              <section className="hive_control">
                <input type="hidden" id="app_users_dataNode" name="app_users_dataNode" value={paramPlatformuserlistUptoken}/>
                <input type="hidden" id="app_users_mosy_action" name="app_users_mosy_action" value={platformuserlistActionStatus}/>
              </section>
