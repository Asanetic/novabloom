...
import { inteprateActiveappusersFormAction, activeappusersProfileData , popDeleteDialog, InteprateActiveappusersEvent } from '../dataControl/ActiveappusersRequestHandler';

//state management
import { useActiveappusersState } from '../dataControl/ActiveappusersStateManager';
...
export default function ActiveappusersProfile({ dataIn = {}, dataOut = {} }) {
  ...
  const {
    ...
    customProfileData={},
    hostParent="ActiveappusersMainProfilePage",
    parentProfileItemId = "ActiveappusersProfileTray"
  ...
  //manage Activeappusers states
  const [stateItem, stateItemSetters] = useActiveappusersState(settersOverrides);
  const app_usersNode = stateItem.activeappusersNode
  
  // -- basic states --//
  const paramActiveappusersUptoken  = stateItem.activeappusersUptoken
  const activeappusersActionStatus = stateItem.activeappusersActionStatus
  ...
  const handleInputChange = mosyFormInputHandler(stateItemSetters.setActiveappusersNode);
  
  //use route navigation system
  const router = useRouter();
  
  //manage post form
  function postActiveappusersFormData(e) {
    
    MosyNotify({message: "Sending request",icon:"send"})
    
    inteprateActiveappusersFormAction(e, stateItemSetters).then(response=>{
      
      setChildDataOut({
        
        actionName : response.actionName,
        dataToken : response.newToken,
        actionsSource : "postActiveappusersFormData",
        setters :{
      ...
      stateItemSetters.setActiveScrollId("ActiveappusersProfileTray")
  ...
  useEffect(() => {
    ...
    activeappusersProfileData(customQueryStr, stateItemSetters, router, customProfileData)
  ...
  return (
    ...
    <div className="p-0 col-md-12 text-center row justify-content-center m-0  " id="ActiveappusersProfileTray">
      {/* ================== Start Feature Section========================== ------*/}
      
      
      <div className="col-md-12 rounded text-left p-2 mb-0  bg-white ">
        <div className={` profile_container col-md-12 m-0 p-0  ${showNavigationIsle &&("pr-lg-4 pl-lg-4 m-0")}`}>
          <form onSubmit={postActiveappusersFormData} encType="multipart/form-data" id="app_users_profile_form">
            ...
            <h3 className="col-md-12 title_text text-left p-0 pt-3 hive_profile_title row justify-content-center m-0 ">
              ...
              <>{!showNavigationIsle && (<div className="col m-0 p-0 text-right ">
                {paramActiveappusersUptoken && (
                  <DeleteButton
                  src="ActiveappusersMainProfilePage"
                  tableName="app_users"
                  uptoken={paramActiveappusersUptoken}
            ...
            {paramActiveappusersUptoken && showNavigationIsle && (
              <>
        ...
        <div className="col-md-12 row justify-content-center m-0  p-0">
            ...
            <div className="col-md-11 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
              ...
              <div className="row justify-content-start col-md-12 p-0 m-0 ">
                ...
                <div className="form-group col-md-4 hive_data_cell ">
                  ...
                  <SmartDropdown
                  apiEndpoint={apiRoutes.activeappusers.base}
                  idField="primkey"
                  labelField="country"
                  inputName="country"
                  label="Country"
            ...
            <div className="col-md-11 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
              ...
              <div className="row justify-content-start col-md-12 p-0 m-0 ">
                ...
                {app_usersNode?.primkey && (
                  ...
                  {app_usersNode?.primkey && (
                    <div className="form-group col-md-3 ">
                      ...
                      <div className="border border_set p-2 rounded_medium form-control pt-3" id="div_total_orders" name="div_total_orders" placeholder="Total Orders">{app_usersNode?.total_orders || ""}</div>
                    </div>)}
                ...
                <section className="hive_control">
                  <input type="hidden" id="app_users_dataNode" name="app_users_dataNode" value={paramActiveappusersUptoken}/>
                  <input type="hidden" id="app_users_mosy_action" name="app_users_mosy_action" value={activeappusersActionStatus}/>
                </section>
            ...
            {app_usersNode?.primkey && (
              <section className="col-md-12 m-0  pt-5 p-0 ">
                ...
                <div className="col-md-12 p-2 text-right ">
                  <a href={`../payments/list?app_users_mosyfilter=${btoa(`  {accountId:btoa(app_usersNode?.record_id)}`)}`} className="cpointer"> View More  <i className="fa fa-arrow-right "></i></a>
                </div>
                ...
                dataIn={{
                  ...
                  customQueryStr :   {accountId:btoa(app_usersNode?.record_id)},
          ...
          {app_usersNode?.primkey && (
            <section className="col-md-12 m-0  pt-5 p-0 ">
              ...
              <div className="col-md-12 p-2 text-right ">
                <a href={`../subscriptions/list?app_users_mosyfilter=${btoa(`  {accountId:btoa(app_usersNode?.record_id)} `)}`} className="cpointer"> View More  <i className="fa fa-arrow-right "></i></a>
              </div>
