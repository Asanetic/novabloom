...
import { inteprateInactiveusersFormAction, inactiveusersProfileData , popDeleteDialog, InteprateInactiveusersEvent } from '../dataControl/InactiveusersRequestHandler';
...
import {
  addUserSubscription
} from '../../users/logicControl/user-addsubscription';

// Imports from user-payments.jsx
import {
  addUserpayments
} from '../logicControl/user-payments';
...
export default function InactiveusersProfile({ dataIn = {}, dataOut = {} }) {
  ...
  const {
    ...
    customProfileData={},
    hostParent="InactiveusersMainProfilePage",
    parentProfileItemId = "InactiveusersProfileTray"
  ...
  const app_usersNode = stateItem.inactiveusersNode
  
  // -- basic states --//
  const paramInactiveusersUptoken  = stateItem.inactiveusersUptoken
  const inactiveusersActionStatus = stateItem.inactiveusersActionStatus
  ...
  const handleInputChange = mosyFormInputHandler(stateItemSetters.setInactiveusersNode);
  
  //use route navigation system
  const router = useRouter();
  
  //manage post form
  function postInactiveusersFormData(e) {
    
    MosyNotify({message: "Sending request",icon:"send"})
    
    inteprateInactiveusersFormAction(e, stateItemSetters).then(response=>{
      
      setChildDataOut({
        
        actionName : response.actionName,
        dataToken : response.newToken,
        actionsSource : "postInactiveusersFormData",
        setters :{
      ...
      stateItemSetters.setActiveScrollId("InactiveusersProfileTray")
  ...
  useEffect(() => {
    ...
    inactiveusersProfileData(customQueryStr, stateItemSetters, router, customProfileData)
  ...
  return (
    ...
    <div className="p-0 col-md-12 text-center row justify-content-center m-0  " id="InactiveusersProfileTray">
      {/* ================== Start Feature Section========================== ------*/}
      
      
      <div className="col-md-12 rounded text-left p-2 mb-0  bg-white ">
        <div className={` profile_container col-md-12 m-0 p-0  ${showNavigationIsle &&("pr-lg-4 pl-lg-4 m-0")}`}>
          <form onSubmit={postInactiveusersFormData} encType="multipart/form-data" id="app_users_profile_form">
            ...
            <h3 className="col-md-12 title_text text-left p-0 pt-3 hive_profile_title row justify-content-center m-0 ">
              ...
              <>{!showNavigationIsle && (<div className="col m-0 p-0 text-right ">
                {paramInactiveusersUptoken && (
                  <DeleteButton
                  src="InactiveusersMainProfilePage"
                  tableName="app_users"
                  uptoken={paramInactiveusersUptoken}
            ...
            <div className="col-md-8 p-0 text-right hive_profile_nav_add_new_tray" id="">
              ...
              {paramInactiveusersUptoken && (
                ...
                label=" add payment"
                icon="copy"
                onClick={()=>{addUserpayments({userRecordId:app_usersNode?.record_id, username:app_usersNode?.full_name})}}
                />
                
              </>
            )}
            
            {paramInactiveusersUptoken && showNavigationIsle && (
              <>
            ...
            <div className="col-md-11 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
              ...
              <div className="row justify-content-start col-md-12 p-0 m-0 ">
                ...
                <div className="form-group col-md-4 hive_data_cell ">
                  ...
                  <SmartDropdown
                  apiEndpoint={apiRoutes.inactiveusers.base}
                  idField="primkey"
                  labelField="country"
                  inputName="country"
                  label="Country"
            ...
            <div className="col-md-11 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
              ...
              <div className="row justify-content-start col-md-12 p-0 m-0 ">
                ...
                <section className="hive_control">
                  <input type="hidden" id="app_users_dataNode" name="app_users_dataNode" value={paramInactiveusersUptoken}/>
                  <input type="hidden" id="app_users_mosy_action" name="app_users_mosy_action" value={inactiveusersActionStatus}/>
                </section>
