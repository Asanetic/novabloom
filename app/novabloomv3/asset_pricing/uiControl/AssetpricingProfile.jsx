...
import { inteprateAssetpricingFormAction, assetpricingProfileData , popDeleteDialog, InteprateAssetpricingEvent } from '../dataControl/AssetpricingRequestHandler';

//state management
import { useAssetpricingState } from '../dataControl/AssetpricingStateManager';
...
import AssetpricingList from './AssetpricingList';
// ════════════════════════════════════════════════════════════════
...
export default function AssetpricingProfile({ dataIn = {}, dataOut = {} }) {
  ...
  const {
    ...
    customProfileData={},
    hostParent="AssetpricingMainProfilePage",
    parentProfileItemId = "AssetpricingProfileTray"
  ...
  //manage Assetpricing states
  const [stateItem, stateItemSetters] = useAssetpricingState(settersOverrides);
  const asset_pricingNode = stateItem.assetpricingNode
  
  // -- basic states --//
  const paramAssetpricingUptoken  = stateItem.assetpricingUptoken
  const assetpricingActionStatus = stateItem.assetpricingActionStatus
  ...
  const handleInputChange = mosyFormInputHandler(stateItemSetters.setAssetpricingNode);
  
  //use route navigation system
  const router = useRouter();
  
  //manage post form
  function postAssetpricingFormData(e) {
    
    MosyNotify({message: "Sending request",icon:"send"})
    
    inteprateAssetpricingFormAction(e, stateItemSetters).then(response=>{
      
      setChildDataOut({
        
        actionName : response.actionName,
        dataToken : response.newToken,
        actionsSource : "postAssetpricingFormData",
        setters :{
      ...
      stateItemSetters.setActiveScrollId("AssetpricingProfileTray")
  ...
  useEffect(() => {
    ...
    assetpricingProfileData(customQueryStr, stateItemSetters, router, customProfileData)
  ...
  return (
    ...
    <div className="p-0 col-md-12 text-center row justify-content-center m-0  " id="AssetpricingProfileTray">
      {/* ================== Start Feature Section========================== ------*/}
      
      
      <div className="col-md-12 rounded text-left p-2 mb-0  bg-white ">
        <div className={` profile_container col-md-12 m-0 p-0  ${showNavigationIsle &&("pr-lg-4 pl-lg-4 m-0")}`}>
          <form onSubmit={postAssetpricingFormData} encType="multipart/form-data" id="asset_pricing_profile_form">
            ...
            <h3 className="col-md-12 title_text text-left p-0 pt-3 hive_profile_title row justify-content-center m-0 ">
              ...
              <>{!showNavigationIsle && (<div className="col m-0 p-0 text-right ">
                {paramAssetpricingUptoken && (
                  <DeleteButton
                  src="AssetpricingMainProfilePage"
                  tableName="asset_pricing"
                  uptoken={paramAssetpricingUptoken}
            ...
            {paramAssetpricingUptoken && showNavigationIsle && (
              <>
      ...
      <div className="row justify-content-center m-0 p-0 col-md-12" id="">
        ...
        <div className="col-md-12 row justify-content-center m-0  p-0">
          ...
          <div className="col-md-12 row p-0 justify-content-center p-0 m-0">
            <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
              ...
              <div className="row justify-content-start col-md-12 p-0 m-0 ">
                ...
                tblName="assets"
                parentTable="asset_pricing"
                inputName="_assets_asset_name_asset_id"
                hiddenInputName="asset_id"
                valueField="record_id"
                displayField="asset_name"
                label="Asset Name"
                defaultValue={{ record_id: asset_pricingNode?.asset_id || "", asset_name: asset_pricingNode?._assets_asset_name_asset_id || "" }}
                onSelect={(id) => console.log("Just the ID:", id)}
                onSelectFull={(dataRes) =>  console.log("Data seleted")}
                onInputChange={handleInputChange}
                defaultColSize="col-md-6"
            ...
            <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
              ...
              <div className="row justify-content-start col-md-12 p-0 m-0 ">
                ...
                <div className="form-group col-md-3">
                  <label className="d-none">Billing period</label>
            ...
            <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
              ...
              <div className="row justify-content-start col-md-12 p-0 m-0 ">
                ...
                value={asset_pricingNode?.total_subscriptions || ""}
                onChange={handleInputChange}
                context={{ hostParent: hostParent  }}
                inputOverrides={{}}
                type="text"
          ...
          <section className="hive_control">
            <input type="hidden" id="asset_pricing_dataNode" name="asset_pricing_dataNode" value={paramAssetpricingUptoken}/>
            <input type="hidden" id="asset_pricing_mosy_action" name="asset_pricing_mosy_action" value={assetpricingActionStatus}/>
          </section>
      ...
      {asset_pricingNode?.primkey && (
        <section className="col-md-12 m-0  pt-5 p-0 ">
          <h5 className="col-md-12 text-left  border-bottom pl-lg-1 text-muted mb-3"> {`Related asset Pricing`} </h5>
          
          <div className="col-md-12 p-2 text-right ">
            <a href={`./list?asset_pricing_mosyfilter=${btoa(` {assetId:btoa(asset_pricingNode?.asset_id)}`)}`} className="cpointer"> View More  <i className="fa fa-arrow-right "></i></a>
          </div>
          ...
          dataIn={{
            ...
            customQueryStr :  {assetId:btoa(asset_pricingNode?.asset_id)},
